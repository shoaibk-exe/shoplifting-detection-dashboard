...
interface DataTableForRolesProps {
    roles: Roles[],
    loading: boolean,
}
const DataTableForRoles = ({ roles, loading }: DataTableForRolesProps) => {
                    ...
                    <>
                        <div className="flex justify-between px-7.5 py-4.5">
                            <div className="relative z-20 w-full max-w-[414px]">
                                <h1 className="font-bold text-xl text-black dark:text-white">Records</h1>
                            </div>
...
export default DataTableForRoles;
