...
export const UserModelDelete = ({ modalOpen, setModalOpen, userDeleteHandler }: any) => {

    return (
        <div>
            {modalOpen && (
                <div className="fixed left-0 top-0 z-999999 flex h-full min-h-screen w-full items-center justify-center bg-[#27918f36] px-4 py-5">
                        ...
                        <svg
                            ...
                            <h3 className="pb-4 mt-4 text-xl font-bold text-dark dark:text-white sm:text-2xl">
                               Please Confirm
                            </h3>
