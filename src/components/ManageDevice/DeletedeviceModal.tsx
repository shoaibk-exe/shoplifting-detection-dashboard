...
const DeleteDeviceModal: React.FC<SavedvideodownloadProps> = ({
    modalOpen,
    setModalOpen,
}) => {
    return (
        <>
            {modalOpen && (
                ...
                >
                    <div className="w-full max-w-[550px] rounded-[15px] bg-white px-8 py-12 text-center dark:bg-gray-dark dark:shadow-card md:px-15 md:py-15">
