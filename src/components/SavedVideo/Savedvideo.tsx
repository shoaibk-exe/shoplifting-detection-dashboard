...
import SavedvideoModal from "./SavedvideoModal";
  ...
  return (
    <div className="flex h-full w-full flex-col rounded-[10px] border border-stroke bg-white p-4 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5">
      <div className="relative overflow-x-auto sm:rounded-lg">
            ...
            {cameras.map((row, index) => (
              ...
              >
                <td className="px-6 py-4">
                  <div className="flex h-8 w-10 items-center justify-center rounded bg-gray-200 dark:bg-dark">
                    <Icons.playButton />
                  </div>
                </td>
        ...
        <SavedvideoModal modalOpen={modalOpen.Savedvideo} setModalOpen={setModalOpen} />
        <DeletevideoModal modalOpen={modalOpen.deleteVideo} setModalOpen={setModalOpen} />
        <ViewvideoModal modalOpen={modalOpen.videoView} setModalOpen={setModalOpen} />
